...
Fixed exposed files and double inits
Named files correctly
created hoc for getInitialProps
there some files which are unused but they serve as examples how it possibly can be.
added an adjacent app page implementation to home page.

# To do

To find out why I can't integrate checkout into shop

# important

tests are not set up - they remained unchanged from the sample.
